...
public class HomeFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstfanceState) {
        // Inflate the layout for this fragment
        mViewInstance = inflater.inflate(R.layout.fragment_home, container, false);
        return mViewInstance;
    }

    View mViewInstance;
    Button btnRescue, btnReplySMS, btnFossick, btnHistory;
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.btn_Rescue:
                ...
                builder.setTitle(R.string.rescure_alert_dialog_title);
                builder.setMessage(R.string.rescure_alert_dialog_message);
                ...
                builder.setNegativeButton(R.string.action_abort, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        dialog.dismiss();
                        MyHelper.toast(getContext(), "Aborted send SMS");
                    }
                });
                builder.show();
                break;
